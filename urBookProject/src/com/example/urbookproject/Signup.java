...
public class Signup extends Activity {
	    ...
	    private String url = "http://204.83.105.45/signup.php";
		String count;
    ...
    private class JsonReadTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			nameValuePairs = new ArrayList<NameValuePair>(5);
 			...
 			nameValuePairs.add(new BasicNameValuePair("lastname",lastName.getText().toString().trim()));
 			nameValuePairs.add(new BasicNameValuePair("firstname",firstName.getText().toString().trim()));
